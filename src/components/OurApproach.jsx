    ...
    <img className="hidden lg:block absolute z-0 pointer-events-none right-0 lg:mt-[36rem] lg:opacity-100 w-[550px]" src="/pitch.png"/>
        ...
        <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
            ...
            <div>
                ...
                <a className="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#dedbcc] border-2 border-[#e5eae6] font-medium text-md text-neutral-800 rounded-lg focus:outline-none" href="/contact">

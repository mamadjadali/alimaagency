        ...
        <div className="mx-auto max-w-7xl py-24  sm:py-32">
          <div className="relative isolate overflow-hidden bg-[#ff4f20] px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-[#19191c]">
              We begin by understanding your unique requirements and assessing your current infrastructure. Our team then designs and implements customized solutions that enhance your network’s efficiency and security. We continuously monitor and manage your systems, adapting to emerging threats and technological advancements.
              </p>
            </div>

...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[200vh] scale-50 flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="text-[#dedbcc] text-5xl font-normal mb-32 text-center animate-pulse"
      >
        {title || (
          <span>

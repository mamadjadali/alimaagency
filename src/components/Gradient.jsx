...
const Gradient = () => {
  return (
    <div className='absolute z-0 w-screen'>
        <svg width="2000" height="1344" viewBox="0 0 1440 1344" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
            <filter id="filter0_f_1_4" x="344.423" y="0.291016" width="2335.21" height="1889.2" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            <feGaussianBlur stdDeviation="200" result="effect1_foregroundBlur_1_4"/>
            </filter>
            <filter id="filter1_f_1_4" x="333.565" y="27.4658" width="2090.25" height="1715.41" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            <feGaussianBlur stdDeviation="200" result="effect1_foregroundBlur_1_4"/>
            </filter>
            ...
            <filter id="filter3_f_1_4" x="344.423" y="0.291016" width="2335.21" height="1889.2" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            <feGaussianBlur stdDeviation="200" result="effect1_foregroundBlur_1_4"/>
            </filter>
            <filter id="filter4_f_1_4" x="333.565" y="27.4658" width="2090.25" height="1715.41" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
            <feGaussianBlur stdDeviation="200" result="effect1_foregroundBlur_1_4"/>
            </filter>
            ...
            <stop offset="0.075" stop-color="#70FE90"/>
            <stop offset="0.24" stop-color="#0C1E1E"/>
            </linearGradient>
            ...
            <stop offset="0.03" stop-color="#0C1E1E"/>
            <stop offset="0.975" stop-color="#70FE90"/>
            </linearGradient>
            <linearGradient id="paint4_linear_1_4" x1="717.591" y1="956.955" x2="2062.4" y2="813.438" gradientUnits="userSpaceOnUse">
            <stop stop-color="#70FE90"/>
            <stop offset="1" stop-color="#70FE90" stop-opacity="0.0470588"/>
            </linearGradient>

...
export function Form() {
  ...
  return (
    <div className="max-w-xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-transparent">
      ...
      “In the realm of innovation, where ideas take flight,  
      Together we’ll weave dreams, in the canvas of light.”
      </h2>
      <p className="text-neutral-600 text-justify text-sm max-w-lg mt-2 dark:text-neutral-300">
